pipeline {
    ...
    stages {
        ...
        stage ('static code analysis') {
            steps {
                withSonarQubeEnv ('sonarserver') {
                    ...
                    -Dsonar.projectName=boardgame-prod \
        ...
        stage ('deploy to eks') {
            steps {
                withKubeConfig(caCertificate: '', clusterName: 'singh-EKS', contextName: '', credentialsId: 'kub', namespace: 'prod', restrictKubeConfigAccess: false, serverUrl: 'https://DBC183504E8FD5E8DE75305339976D8C.gr7.ap-southeast-1.eks.amazonaws.com') {
